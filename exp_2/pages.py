...
class Final(Page):
    ...
    def vars_for_template(self):
        ...
        self.player.payoff_total = round((float(self.player.total_bonus) + float(self.player.participant.vars['payoff_trust']) + float(self.player.participant.vars['payoff_cem'])) * 0.02,2)
