...
class Player(BasePlayer):
    ...
    coffee_howoften = models.StringField(
        choices=[['Multiple daily', 'Multiple times daily'], ['Daily', 'Daily'], ['Weekly', 'Weekly'],
    ...
    door_unlocked = models.StringField(
        choices=[['Very often', 'Very often'], ['Often', 'Often'], ['Sometimes', 'Sometimes'], ['Rarely', 'Rarely'],
                 ['Never', 'Never'],
                 ['Not_to_answer', 'Prefer not to answer']],
    ...
    lend_money = models.StringField(
        choices=[['More_once a week', 'More than once a week'], ['Once a week', 'About once a week'],
                 ['Once a month', 'About once a month'], ['Once a year', 'Once a year or less'],
                 ['Not_to_answer', 'Prefer not to answer']],
    ...
    more_pay_fair_trade = models.StringField(
        choices=[['Nothing', 'Nothing'], ['1 Dollar', '1 Dollar'], ['2 Dollars', '2 Dollars'],
                 ['3 Dollars', '3 Dollars'], ['4 Dollars_more', '4 Dollars or more'],
                 ['Not_to_answer', 'Prefer not to answer']],
    ...
    car = models.StringField(
        choices=[['Strongly agree', 'Strongly agree'], ['Somewhat agree', 'Somewhat agree'],
                 ['Indifferent', 'Indifferent'], ['Somewhat disagree', 'Somewhat disagree'],
    ...
    gender = models.StringField(
        choices=[['Male', 'Male'], ['Female', 'Female'], ['third gender', 'Non-binary/third gender'],
                 ['Not_to_answer', 'Prefer not to answer'],
    ...
    edu = models.StringField(
        choices=[['No high school', 'Some or no high school'], ['High school', 'High school degree or equivalent'],
                 ['College', 'Some college'], ['Associate', 'Associate’s degree or equivalent'],
                 ['Bachelor', 'Bachelor’s degree or equivalent'], ['Graduate', 'Graduate degree or equivalent'],
                 ['Not_to_answer', 'Prefer not to answer']],
    ...
    major = models.StringField(
        choices=[['Business', 'Business Administration'],
                 ['Social Sciences', 'Social Sciences (Anthro., Pol. Science, History)'], ['Economics', 'Economics'],
                 ['Sciences', 'Sciences (Bio., Physics, Math, Chem.)'],
                 ['Medicine', 'Medicine'], ['Engineering', 'Engineering'], ['Law', 'Law'],
                 ['Arts', 'Arts and Humanities'], ['Architecture', 'Architecture and Design'],
                 ['Not_to_answer', 'Prefer not to answer'],
                 ['Other', 'Other']],
    ...
    employment = models.StringField(
        choices=[['Full-time', 'Working full-time'], ['Part-time', 'Working part-time'],
                 ['Unemployed', 'Unemployed and looking for work'],
                 ['Homemaker', 'A homemaker or stay-at-home parents'],
                 ['Student', 'Student'], ['Retired', 'Retired'], ['Not_to_answer', 'Prefer not to answer'],
                 ['Other', 'Other']],
    ...
    income = models.StringField(
        choices=[['less_$10,000', 'Less than $10,000'], ['$10,000-$19,999', '$10,000 to $19,999'],
                 ['$20,000-$29,999', '$20,000 to $29,999'], ['$30,000-$39,999', '$30,000 to $39,999'],
                 ['$40,000-$49,999', '$40,000 to $49,999'], ['$50,000-$59,999', '$50,000 to $59,999'],
                 ['$60,000-$69,999', '$60,000 to $69,999'], ['$70,000-$79,999', '$70,000 to $79,999'],
                 ['$80,000-$89,999', '$80,000 to $89,999'], ['$90,000-$99,999', '$90,000 to $99,999'],
                 ['$100,000-$149,999', '$100,000 to $149,999'], ['$150,000_more', '$150,000 or more'],
                 ['Not_to_answer', 'Prefer not to answer']
                 ],
    ...
    marital = models.StringField(
        choices=[['Married', 'Married'], ['Living_with_partner', 'Living with a partner'], ['Widowed', 'Widowed'],
                 ['Divorced', 'Divorced'],
    ...
    def set_payoff(self):
        self.participant.payoff = self.cost_bonus + self.participant.vars['payoff_trust'] + self.participant.vars['payoff_cem']
