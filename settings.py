...
dict(
        ...
        app_sequence=['consent_group', 'trust2', 'cem', 'exp_2_onebid', 'survey_single'],
        a1=0.2,
        a2=0.2,
        u2=7,
        l2=1,
...
dict(
        ...
        num_demo_participants = 1,
        app_sequence=['consent_group','trust2','cem', 'exp_2_notest', 'survey_single'],
        a1=0.2,
        a2=0.2,
        u2=7,
        l2=1,
    ...
    dict(
        ...
        num_demo_participants = 1,
        app_sequence=['consent_group','trust2','cem','exp_2_single','survey_single'],
        a1=0.2,
        a2=0.2,
        u2=7,
        l2=1,
