...
dict(
        ...
        app_sequence=['consent_group2', 'trust', 'cem', 'exp_2_onebid', ],
        a1=0.2,
        a2=0.2,
        u2=7,
        l2=1,
...
dict(
        ...
        num_demo_participants = 1,
        app_sequence=['consent_group2','trust','cem', 'exp_2_notest', ],
        a1=0.2,
        a2=0.2,
        u2=7,
        l2=1,
    ...
    dict(
        ...
        num_demo_participants = 1,
        app_sequence=['consent_group2','trust','cem','exp_2_single', ],
        a1=0.2,
        a2=0.2,
        u2=7,
        l2=1,
    ...
    dict(
        ...
        app_sequence=['consent_group2','trust2', 'cem', 'RandomGrouping', 'exp_2_group'],
        a1=0.2,
        a2=0.2,
        u2=7,
        l2=1,
